...
namespace help {
    ...
    namespace general {
        ...
        void usage(std::string_view argz) {
            std::cout
            << _("usage") << ": " << fg::green(argz) << " [" << fmt::ul(_("action")) << "] [..." << _("options") << "]\n"
            << fg::magenta(_("actions")) << ": "
            << fmt::ul("init")    << ", "
            << fmt::ul("config")  << ", "
            << fmt::ul("link")    << ", "
    ...
    namespace config {
        ...
        namespace dump {
            void help(std::string_view argz) {
                std::cout
                << fg::green(argz) << " " << fmt::ul("config") << " " << fmt::ul("dump") << ":\n\n"
        ...
        namespace get {
            void help(std::string_view argz) {
                std::cout
                << fg::green(argz) << " " << fmt::ul("config") << " " << fmt::ul("get") << ":\n\n"
